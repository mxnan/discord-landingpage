  ...
  return (
    <section className="w-full h-[80vh]">
      <div className="w-full h-full flex justify-center items-center">
        <div
          className="relative h-max w-full flex flex-col rounded-2xl  p-2 items-center justify-center
         xl:mx-60 
          bg-stone-300 "
        >
          {/*SVG 1*/}
          ...
          <motion.svg
            ...
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.5, delay: 0.5 }}
            className={"w-full h-full scale-x-[-1] scale-y-[-1]"}
            viewBox="0 0 531 49"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <motion.button
            ...
            flex items-center border-1 justify-center gap-2
             bg-[#0a3f94] bg-opacity-60 rounded-3xl font-semibold px-6
              p-3"
          >
