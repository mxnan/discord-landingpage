  ...
  return (
    <section className="w-full h-[200vh]">
      <div className=" relative w-full h-full flex justify-center items-center">
        <div
          className="relative h-[50vh] w-full flex  rounded-2xl  p-2 items-center justify-center
         xl:mx-60 
          bg-stone-300 "
        >
          {/*SVG 1*/}
          ...
          <motion.button
            ...
            flex items-center border-1 justify-center gap-2 text-2xl
